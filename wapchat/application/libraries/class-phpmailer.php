...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'root@165.232.183.220';
  ...
  */
   ...
   * by SERVER_NAME is used or '165.232.183.220.localdomain'.
   * @var string
   */
  public $Hostname          = '';
 ...
 */
  ...
  */
  ...
  /**
   * Returns the server hostname or '165.232.183.220.localdomain' if unknown.
   * @access protected
   * @return string
   */
  protected function ServerHostname() {
    if (!empty($this->Hostname)) {
      ...
      $result = '165.232.183.220.localdomain';
    }
