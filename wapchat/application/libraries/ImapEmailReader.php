...
include("/var/www/html/zra/include/class-phpmailer.php");
...
$link = mysql_connect("139.59.10.9","cron","1234") or die("Could not connect: " . mysql_error());

//$link = mysql_connect("139.59.10.9","root","All1@nc3@1986!") or die("Could not connect: " . mysql_error());

mysql_select_db("zra_master");
	...
	if($emails) 
	{
		...
		foreach($emails as $email_number) 
		{
			...
			*/
			...
			$sql_insert_information="INSERT INTO zra_master.web_email_information 
							(v_toemail,v_fromemail,d_email_date,v_subject,Filter_bySubject,Filter_byFrom,
								V_rule,v_body,email_type,ICASEID,i_Update_status,orginal_subject,email_test, i_UID) 
