<?php 
$base_url_new = 'https://alliance-infotech.in/ensembler/';
...
<head>
  ...
  <link rel="icon" type="image/png" href="http://165.232.183.220/zra/CRM/images/HELB.png"/>
    <!-- DataTables -->
 ...
 <nav class="main-header navbar navbar-expand-md navbar-light navbar-light" style="margin-left:0">
    <div class="container-fluid">
      ...
      <a href="<?php echo $base_url_new;?>/CRM/wap.php" class="navbar-brand" style="margin-top: -27px; margin-bottom: -27px;" >
        <img src="<?php echo base_url() ?>../public/images/HELB.png" alt="Ensembler Logo" class="brand-image" style="height: 56px;">
