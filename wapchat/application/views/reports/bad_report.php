        ...
        <div class="col-md-12">
          <div class="card card-info card-outline">
            <div class="card-header">
              <form name="report_search" id="report_search" autocomplete="on" action="<?php echo site_url('reports/bad_report') ?>"  method="post" >
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <form id="remove_bad_records" name="remove_bad_records" method="post" enctype="multipart/form-data" >
...
$("#remove_bad_records").on('submit', function(event) {
  ...
  var url = '<?php echo site_url('reports/remove_bad_records')?>';
  $.ajax({
    url:url,
    method:'POST',
    ...
    success:function(data, textStatus, jqXHR){
      ...
      if(data.status=='success'){
         successMsg(data.msg);
         window.location.href="<?php echo base_url(); ?>reports/bad_report";  
  ...
  var inout_report = '<?php echo $report_in_out ?>' ;
      ...
      $("#report-server-side").DataTable({
       ...
       /* "columns": [
        ...
        "ajax":{
            "url": "<?php echo site_url('reports/get_bad_records') ?>",
            "dataType": "json",
            "type": "POST",
