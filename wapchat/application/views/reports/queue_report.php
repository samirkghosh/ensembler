        ...
        <div class="col-md-12">
          <div class="card card-info card-outline">
            <div class="card-header">
              <form name="report_search" id="report_search" autocomplete="on" action="<?php echo site_url('reports/queue_report') ?>"  method="post" >
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">End Date
                          ...
                          <div class="col-md-2">Campaign wise :              
                          ...
                          <?php if(strtolower($this->session->userdata('admin')['role']) =='admin'): ?>
                          <div class="col-md-2">User wise :               
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <form id="remove_out_queue" name="remove_out_queue" method="post" enctype="multipart/form-data" >
              <div class="table-responsive">
                <table class="table table-striped table-bordered table-sm" id="report-server-side">
                  <thead>
                    <tr>
                      <th># <input type="checkbox" name="select_all" id="select_all" class="select_all"></th></th>
                      <th>Sender ID</th>
                      <th>Name</th>
                      <th>Message</th>
                      <th>PDU</th>
              ...
              <button type="submit" class="btn btn-warning btn-sm" id="delete_contact">Remove</button>
              </form>    
...
$("#remove_out_queue").on('submit', function(event) {
  ...
  var url = '<?php echo site_url('reports/remove_outqueue_records')?>';
  $.ajax({
    url:url,
    method:'POST',
    ...
    success:function(data, textStatus, jqXHR){
      ...
      if(data.status=='success'){
         successMsg(data.msg);
         window.location.href="<?php echo base_url(); ?>reports/queue_report";  
  ...
  var inout_report = '<?php echo $report_in_out ?>' ;
      ...
      $("#report-server-side").DataTable({
       ...
       /* "columns": [
        ...
        "ajax":{
            "url": "<?php echo site_url('reports/get_queue_records') ?>",
            "dataType": "json",
            "type": "POST",
