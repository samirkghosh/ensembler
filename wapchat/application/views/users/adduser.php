...
<!-- Content Wrapper. Contains page content -->
  <div class="content">
    ...
    <section class="content">
       ...
       <div class="container-fluid">
    <form class="form-horizontal" id="addcnt" action="<?php echo site_url('user/add_user')?>" method="post">
      <div class="row">
        <div class="col-md-7">
              ...
              <div class="card-body">
                ...
                <div class="row">
                   <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="fname" name="fname" placeholder="First Name" maxlength="100" value="<?php echo set_value('fname'); ?>">
                   ...
                   <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="lname" name="lname" placeholder="Last Name" maxlength="100" value="<?php echo set_value('lname'); ?>">
                   ...
                   <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="User Name" maxlength="100" value="<?php echo set_value('name'); ?>">
                ...
                <div class="row">
                   <div class="col-sm-4">
                      <div class="form-group">
                        <label >Email</label>
                        <input type="email" class="form-control" id="email" name="email" placeholder="Enter User Email" maxlength="100" value="<?php echo set_value('email'); ?>">
                   ...
                   <div class="col-sm-4">
                      <div class="form-group">
                        <label >Mobile</label>
                        <input type="text" class="form-control" id="mobile" name="mobile" placeholder="Enter User mobile" maxlength="12" value="<?php echo set_value('mobile'); ?>">
                   ...
                   <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="sms_quota" name="sms_quota" placeholder="Enter sms quota" maxlength="15" value="<?php echo set_value('sms_quota'); ?>">
                          ...
                          <select class="form-control" name="roles">
                            <option value="0">--Select Roles--</option>
                              <?php
                                ...
                                <?php
                                    /*if ($s_value->is_active == $s_key) {
                                        echo "selected=selected";
                                    }*/
                                    ?>
                                  <option value="<?php echo $s_value->id; ?>" <?php echo set_select('roles', $s_value->id) ?> ><?php echo $s_value->name; ?></option>
                              <?php
                                }
                                ?>
                          </select>
        ...
        <!-- /.col -->
         ...
         <div class="col-md-5 ">
          <div class="card card-info card-outline" style="border-color: coral;">
            <div class="card-header">
              <h3 class="card-title">User Assigned SMS Templates </h3>
