    ...
    function permission($id) {
        ...
        if ($this->input->server('REQUEST_METHOD') == "POST") {
            ...
            foreach ($per_cat_post as $per_cat_post_key => $per_cat_post_value) {
                log_message('error', ' per_cat_post_key '.$per_cat_post_key);
                log_message('error', ' per_cat_post_value '.$per_cat_post_value);
                $insert_data = array();
                $ar = array();
