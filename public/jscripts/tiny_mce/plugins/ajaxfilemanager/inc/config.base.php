<?php include("../../../../../mysqlconnect.php"); // Add by abhishek for add the folder path 
	/**
...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	$ppp='../../../../../uploaded/';
	define('CONFIG_SYS_DEFAULT_PATH', $ppp); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', $ppp);	//accept relative path only 
	...
	define('CONFIG_IMG_THUMBNAIL_MAX_Y', 50);
		 ...
		 * 			?>
		 *   3. upload document_root.php to you website root folder which will only be reached when you visit http://www.domain-name.com or http://167.71.232.203/ at 167.71.232.203 computer
		 *   4. run it via http://www.domain-name.com/document_root.php or http://167.71.232.203/docuent_root.php if 167.71.232.203 computer, the url has to be exactly like that 
