...
?>
<link rel="stylesheet" type="text/css" href="<?=$SiteURL?>CRM/omnichannel_config/css/bulk_sms_report.css">
<div class="col-sm-9 mt-3" style="padding-left: 0;">
  <form name="myform" method="post">
    <div class="style2-table">
      <div class="table">
        <span class="breadcrumb_head" style="height: 37px; padding: 9px 16px;">SMS BULK REPORT</span>
