...
?>
<link rel="stylesheet" type="text/css" href="<?=$SiteURL?>CRM/omnichannel_config/css/bulk_email_report.css">
<div class="col-sm-9 mt-3" style="padding-left:0">
  <form name="myform" method="post">
    <div class="style2-table ">
        <div class="table">
        <span class="breadcrumb_head" style="height:37px;padding:9px 16px">Email BULK REPORT</span>
              ...
              <tbody>
                <tr>
                  ...
                  <tr>
                      ...
                      <td class="left boder0-left ">
                        <label> From 
                        <input type="text" name="from_date" class="date_class dob1" value="<?=$startdatetime?>" id="startdatetime"></label>
                        <label>
                        To <input type="text" name="end_date" class="date_class dob1" value="<?=$enddatetime?>" id="enddatetime"></label>
                      </td>
                </tr>
                <tr>
                    ...
                    <center>
                      <input type='submit' name='sub1' value='Run Report' class="button-orange1" style="float:inherit;">
                       <button type="button"  id="reset" name="reset" class="btn button-orange1" title="Reset filters" style="float:inherit;color:#222;text-decoration:none;padding:6px"><i class="fas fa-power-off"></i>Reset</button></center>
                    </td>
                </tr>
          </table>
        </div>
