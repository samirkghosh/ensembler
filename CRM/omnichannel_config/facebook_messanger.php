<?php
/***
    * Messanger Detail Page
    * Author: Aarti Ojha
    * Date: 07-08-2024
    * This file handles Facebook Messanger Chat display
    * To integrate Facebook messaging in your PHP application using the Facebook Business API, you need to follow several steps, including setting up your Facebook Developer account, creating a Facebook Business Account, configuring your webhook, and handling incoming and outgoing messages
    * 
...
// function  file for updating date according to latest month record [vastvikta][18-03-2025]
  ...
  $module_flag_customer = module_license('Facebook Messenger');
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="row">
                  <div class="col-sm-3">
                      <div class="row">
                         <div class="col-sm-7">FACEBOOK MESSENGER</div>
                       </div>
                  </div>
    ...
    <form method="post" name="cfrm" id="post_complaint">
		 ...
		 <table class="tableview tableview-2 main-form new-customer">
			...
			<tr>
			   ...
			   <td class="left boder0-right">Facebook Messenger
        ...
        <td width="230" align="left" class="left boder0-right">
            <span class="left boder0-left">
                <?php $query = mysqli_query($link, "SELECT send_from FROM $db.messenger_in_queue WHERE send_from != '' GROUP BY send_from ASC "); ?>
                
                <input  id="searchSenderBox" placeholder="Search Sender Id. And Select.." onkeyup="filterFunction('send_from', 'searchSenderBox', 'noSenderMessage')" style="width:180px; height:30px; margin-bottom: 5px;">
                ...
                <label>Sender Name</label>
                        ...
                        <td class="left boder0-right">
                            &nbsp;<select name="send_name" class="select-styl1" id="send_name">
                                ...
                                $result = mysqli_query($link, "SELECT fname, lname ,messengerhandle FROM $db.web_accounts where messengerhandle!='' ");
                                ...
                                if ($result) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo '<option value="' . $messengerhandle . '">' . htmlspecialchars($fullname) . '</option>';
                                    }
                                } else {
