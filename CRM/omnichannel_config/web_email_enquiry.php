 ...
 * Date:  13 Mar  2024
 * Description: To display Data Related To Web email Complaint 
 * 
*/
        ...
        <div class="col-sm-12">
          <div class="row">
                ...
                <div class="row">
                   ...
                   <div class="col-sm-5">
                    <select name="page" onchange="window.location=this.value">
                                    ...
                                    ?>
                        <option value="omni_channel.php?token=<?php echo $email_complaint?>" >COMPLAINT</option>
                        <option value="omni_channel.php?token=<?php echo $email_enquiry?>" selected>ENQUIRY</option>
                    </select>
                </div>
                 </div>
            </div>
            ...
            <div class="Reports-page#" style="display: block;border: #d4d4d4 1px solid;marginbottom:20px;min-height: 420px;margin-top:37px;background-color: #fff;">
                <form method="post" name="cfrm" id="post_enquiry">
                        ...
                        <table class="tableview tableview-2 main-form new-customer">
                            <tr>
                                ...
                                <label>Start Date </label>
                                    ...
                                    $dateRange =  get_date_email_enquiry();
                              ...
                              ?>
                                ...
                                <td width="200" class="left boder0-right">
                                    <label>Email ID</label>
                                    <span class="left boder0-left">
                                        <input type="text" class="select-styl1" id="email" name="email" value="<?=$email?>">
                                    </span>
                                </td>
                                <td width="200" class="left boder0-right"> <label>Status</label>
                                    ...
                                    <select name="allstatus" id="iallstatus" class="select-styl1">
                                        ...
                                        <option value="0" <? if($iallstatus==0) echo "selected" ; ?>>Case Not Created
                                        </option>
                                        <option value="1" <? if($iallstatus==1) echo "selected" ; ?>>Case Created
                                        </option>
                    ...
                    <!--   * Author: Ritu Modi 
                           ...
                           * On the advice of ajay sir i have added one filters so that the data can be seached easily.-->
                                ...
                                <td class="left  boder0-left" colspan="4">
                                    <input type='submit' name='sub1' value='Run Report' id = "set_button_enquiry" class="button-orange1 set_button" />
                                    <input type='button' name='reset' value='Reset' id = "reset_button_enquiry" class="button-orange1 reset_button">
                                </td>
                            </tr>
                            </table>
                        </div>
                        <div class="table">
                        <table class="tableview tableview-2" id="email_enquiry_table">
                            <thead>
                                <tr class="background">
                                    <td align="left" valign="center" width="6%" >S.No.</td>
                                    <td align="left" valign="center" width="15%" >Date </td>
