...
<body>
         ...
         <div class="container-fluid mt-2"  id="html-content" style="background-color: white !important;">
            ...
            <div class="row px-2">
               ...
               <div class="d-flex justify-content-between align-items-center">
                  <span style="margin-bottom:10px;">CRM</span>
                  <button class="btn btn-sm" type="button" style="margin-bottom:10px;" data-bs-toggle="collapse" data-bs-target="#crmCollapse" aria-expanded="true" aria-controls="crmCollapse">
                     <i class="fas fa-minus" id="crmToggleIcon"></i>
                  </button>
               </div>
               <div class="collapse show" id="crmCollapse">
                  <div class="row">
                     <div class="col-md-3">
                        <div class="info-box">
  ...
  document.addEventListener("DOMContentLoaded", function () {
    const toggleBtn = document.querySelector('[data-bs-target="#crmCollapse"]');
    const icon = document.getElementById("crmToggleIcon");
    const collapseElement = document.getElementById("crmCollapse");
  ...
  document.addEventListener("DOMContentLoaded", function () {
    const toggleBtn = document.querySelector('[data-bs-target="#crmCollapse2"]');
    const icon = document.getElementById("crmToggleIcon2");
    const collapseElement = document.getElementById("crmCollapse2");
  ...
  document.addEventListener("DOMContentLoaded", function () {
    const toggleBtn = document.querySelector('[data-bs-target="#crmCollapse3"]');
    const icon = document.getElementById("crmToggleIcon3");
    const collapseElement = document.getElementById("crmCollapse3");
  ...
  document.addEventListener("DOMContentLoaded", function () {
    const toggleBtn = document.querySelector('[data-bs-target="#crmCollapse4"]');
    const icon = document.getElementById("crmToggleIcon4");
    const collapseElement = document.getElementById("crmCollapse4");
    ...
    collapseElement.addEventListener('hide.bs.collapse', () => {
      ...
      icon.classList.add("fa-plus");
               ...
               <div class="d-flex justify-content-between align-items-center">
                  <span style="margin-bottom:10px;">Telephony</span>
                  <button class="btn btn-sm" type="button" style="margin-bottom:10px;" data-bs-toggle="collapse" data-bs-target="#crmCollapse2" aria-expanded="true" aria-controls="crmCollapse">
                     <i class="fas fa-minus" id="crmToggleIcon2"></i>
                  </button>
               </div>
               <div class="collapse show" id="crmCollapse2">
                  <div class="row">
                     <div class="col-md-3">
                        <div class="info-box">
            ...
            <div class="row px-2">
               ...
               <div class="d-flex justify-content-between align-items-center">
                  <span style="margin-bottom:10px;">Channel Utilization</span>
                  <button class="btn btn-sm" type="button" style="margin-bottom:10px;" data-bs-toggle="collapse" data-bs-target="#crmCollapse3" aria-expanded="true" aria-controls="crmCollapse">
                     <i class="fas fa-minus" id="crmToggleIcon3"></i>
                  </button>
               </div>
               <div class="collapse show" id="crmCollapse3">
                  <div class="row">
                     ...
                     <div class="col-md-3">
                        <div class="info-box">
                           ...
                           <div class="info-box-content">
                              <div class="row">
                                 <div class="col-sm-12"><span class="info-box-text">Facebook Post</span></div>
                     ...
                     <div class="col-md-3">
                        <div class="info-box">
                           <span class="info-box-icon bg-success"><i class="fab fa-facebook-messenger"></i></span>
                           <div class="row" style="display: block; white-space: normal; word-break: break-word;">
                              <div class="col-sm-12">
                                 <span class="info-box-text"  style="line-height: 1; margin-bottom: 4px;margin-left:15px;">Facebook<br>Messenger</span>
                              </div>
                              <div class="col-sm-12">
                                 <span class="info-box-number" id="messenger_bot" style="line-height: 1; margin-top: 2px;margin-left:15px;">0</span>
                              </div>
                           </div>
                           <!-- /.info-box-content -->
                        </div>
                    ...
                    <div class="col-md-3">
                      <div class="info-box">
                          <span class="info-box-icon bg-primary"><i class="fab fa-instagram"></i></span>
                          <div class="info-box-content">
                              <div class="row" style="display: block; white-space: normal; word-break: break-word;">
                                  <div class="col-sm-12"><span class="info-box-text" style="line-height: 1; margin-bottom: 4px;">Instagram <br>Messenger</span></div>
                                  <div class="col-sm-12"><span class="info-box-number" id="instagram_recieved"  style="line-height: 1; margin-top: 2px;">0</span></div>
                              </div>
                          </div>
                          <!-- /.info-box-content -->
                      </div>
                  ...
                  <div class="col-md-3">
                      <div class="info-box">
                          ...
                          <div class="info-box-content">
                              <div class="row" style="display: block; white-space: normal; word-break: break-word;">
                                  <div class="col-sm-12"><span class="info-box-text" >Instagram Post</span></div>
                                  <div class="col-sm-12"><span class="info-box-number" id="instagram_posts_recieved" >0</span></div>
                              </div>
                          </div>
                          <!-- /.info-box-content -->
                      </div>
               ...
               <div class="col-sm-6 card" style="padding-top: 15px;background: #b063eb2b;border: 0.5px solid #2222;">
               <div class="d-flex justify-content-between align-items-center">
               <span style="margin-bottom:10px;">Telephony Utilization</span>
               <button class="btn btn-sm" type="button" style="margin-bottom:10px;" data-bs-toggle="collapse" data-bs-target="#crmCollapse4" aria-expanded="true" aria-controls="crmCollapse">
                     <i class="fas fa-minus" id="crmToggleIcon4"></i>
                  </button>
               </div>
               <div class="collapse show" id="crmCollapse4">
                  <div class="row">
                     <div class="col-md-3">
                           <div class="info-box">
                           ...
                           if ($num_liveuser) {
                              while ($row_agent = mysqli_fetch_array($sql_agent)) {
                                 ...
                                 if ($row_agent['status'] == 'INCALL') {
                                    $status_show = '<span class="users-list-date badge badge-danger text-white mx-3">Incall</span>';
                                 } else if ($row_agent['status'] == 'PAUSED') {
                                    $status_show = '<span class="users-list-date badge badge-success text-white mx-3">paused</span>';
                                 } else if ($row_agent['status'] == 'READY') {
                                    $status_show = '<span class="users-list-date badge badge-info text-white mx-3">ready</span>';
                                 } else if ($row_agent['status'] == 'WRAPUP') {
                                    $status_show = '<span class="users-list-date badge badge-success text-white mx-3">wrapup</span>';
                                 } else if ($row_agent['status'] == 'MWRAPUP') {
                                    $status_show = '<span class="users-list-date badge badge-primary text-white mx-3">mwrapup</span>';
                                 } else if ($row_agent['status'] == 'MINCALL') {
                                    $status_show = '<span class="users-list-date badge badge-warning text-white mx-3">mincall</span>';
                                 }
