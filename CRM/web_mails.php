<?php
    ...
    function fetchDispositionTypes($link, $db){
        $query = "SELECT * FROM $db.channel_disposition_type";
        $result = mysqli_query($link, $query);
    
        $disposition_types = [];
        while ($row = mysqli_fetch_assoc($result)) {
            $disposition_types[] = $row['name'];
        }
    
        return $disposition_types;
    }
    // Function to generate the <select> HTML options
    function DispoSelectOptions($disposition_types, $selected_value = ''){
        $options = '<option value="">Please Select Disposition</option>';

        foreach ($disposition_types as $type) {
            $selected = ($type == $selected_value) ? 'selected' : '';
            $options .= '<option value="' . htmlspecialchars($type, ENT_QUOTES, 'UTF-8') . '" ' . $selected . '>' . htmlspecialchars($type, ENT_QUOTES, 'UTF-8') . '</option>';
        }
...
?>
<!-- web mails page start -->
<link rel="stylesheet" href="<?=$SiteURL?>public/datatables/css/dataTables.dataTables.css">
<link rel="stylesheet" href="<?=$SiteURL?>public/datatables/css/buttons.dataTables.css">
<link rel="stylesheet" href="<?=$SiteURL?>public/css/email.css">
...
<script src="<?=$SiteURL?>public/datatables/js/dataTables.buttons.js"></script>
<script src="<?=$SiteURL?>public/datatables/js/buttons.dataTables.js"></script>
<script src="<?=$SiteURL?>public/datatables/js/jszip.min.js"></script>
<script src="<?=$SiteURL?>public/datatables/js/pdfmake.min.js"></script>
<script src="<?=$SiteURL?>public/datatables/js/vfs_fonts.js"></script>
<script src="<?=$SiteURL?>public/datatables/js/buttons.html5.min.js"></script>
<script src="<?=$SiteURL?>public/datatables/js/buttons.print.min.js"></script>
<script src="<?=$SiteURL?>public/js/mail.js"></script>