 ...
 * Date: 31 Jan 2024
 * Description: Create and Update Webchat Template - Refactored for Security
 */
...
<form id="webchatTemplateForm" method="post">
    <input name="id" id="id" type="hidden" value="<?php echo htmlspecialchars($id, ENT_QUOTES, 'UTF-8'); ?>">
    <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrf_token, ENT_QUOTES, 'UTF-8'); ?>">
    <span class="breadcrumb_head" style="height:37px;padding:9px 16px"><?php echo (!empty($id) ? "Edit" : "New"); ?> Webchat Template</span>
...
document.addEventListener('DOMContentLoaded', function() {
    const form = document.getElementById('webchatTemplateForm');
    ...
    form.addEventListener('submit', function(e) {
        ...
        const action = id ? 'update_webchat_template' : 'create_webchat_template';
