 ...
 * Date: 23-05-2025
 * Description: Display and Delete webchat template - Refactored for Security
 */
...
$webchat_new_template_token = base64_encode('webchat_new_template');
?>
<div class="style2-table">
    <div class="style-title">
        <h3>WebChat Template</h3>
        <div class="row">
            <div class="col-sm-3" style="text-align: end;">
                <a href="admin_index.php?token=<?php echo htmlspecialchars($webchat_new_template_token, ENT_QUOTES, 'UTF-8'); ?>" class="button-orange1">New WebChat Format</a>
            </div>
        </div>
    </div>
    ...
    <div class="table" id="SRallview">
        <table class="tableview tableview-2" id="admin_table">
            ...
            <tbody id="webchat-template-list">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const newTemplateToken = '<?php echo $webchat_new_template_token; ?>';
    const siteUrl = '<?php echo isset($SiteURL) ? htmlspecialchars($SiteURL, ENT_QUOTES, 'UTF-8') : ''; ?>';

    function fetchTemplates() {
        fetch('webchat.php?action=get_webchat_templates')
            .then(response => response.json())
            .then(data => {
                const tbody = document.getElementById('webchat-template-list');
                tbody.innerHTML = '';
                        ...
                        const row = `
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#" data-id="${template.id}" class="webchat_delete">
    ...
    function attachDeleteHandlers() {
        document.querySelectorAll('.webchat_delete').forEach(button => {
            button.addEventListener('click', function(e) {
                ...
                if (confirm('Are you sure you want to delete this template?')) {
                    ...
                    formData.append('action', 'delete_webchat_template');
