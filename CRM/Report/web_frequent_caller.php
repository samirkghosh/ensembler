<?php
/***
 * Frequent Caller page
 * Author: Ritu modi
 * Date: 01-02-2024
 * 
 * This form generates a report of frequent callers based on specified time periods or custom date ranges. It allows users to filter the report by selecting predefined time periods or entering custom date ranges. The form submits the data via POST method to the server for processing.
**/?>
<?php     
...
<form name="myform" method="post">
    <span class="breadcrumb_head" style="height:37px;padding:9px 16px">Frequent Caller</span>
    <div class="table">              
            ...
            <tbody>              
                <tr>
                  <td class="left boder0-right"><label>Time Period</label>
                    ...
                    <?php
                        ...
                        $dateRange = get_date_frequent_caller();
                ...
                <tr>
                  ...
                  <td colspan="3" class="left boder0-right">
                    <span class="left  boder0-left">
                             <input name="submit" id="submit_caller" type="button" value="Run Report" class="button-orange1">
                              <input name="reset" id="reset_caller" type="button" value="RESET" class="button-orange1">
                    </span>
                  </td>
                </tr>
            </tbody>
        ...
        <!-- Start Display the filter data -->
         ...
         <form name="frmService" method="post">
            <div class="wrapper6">
               <div>
                  <table class="tableview tableview-2" id="fc_data">
                    <thead>
                      <tr class="" style="font-size: 12px">
                          ...
                          <th align="center">Call Counts</th>
                      </tr>
                    </thead>
                </table>
            </div>
